...
export default function NavBar() {
  ...
  return (
    <header className="bg-white fixed w-full border-b border-gray-300/40 top-0 z-50">
      <nav
      ...
      >
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a
            href="#"
            className="text-sm font-semibold leading-6 text-gray-50 bg-blue-700 py-3 px-6 rounded-md hover:bg-blue-600"
          >
